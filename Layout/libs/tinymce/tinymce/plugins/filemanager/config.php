...
$upload_dir = '/assets/themes/backend/lib/tinymce/images/'; // path from base_url to upload base dir
$current_path = '../../../../tinymce/images/'; // relative path from filemanager folder to upload files folder

$MaxSizeUpload=100; //Mb
// $base_url=$_SERVER['HTTP_HOST']; //url base of site if you want only relative url leave empty
// $upload_dir = '/bkkp/assets/themes/backend/lib/tinymce/images';
// $current_path = dirname(__FILE__); // relative path from filemanager folder to upload files folder
//**********************
//Image config
//**********************
